...
async function main() {
  ...
  // const MahaChildToken = await hre.ethers.getContractFactory("MahaChildToken");
  // const token = await MahaChildToken.deploy();
  // await token.deployed();
  // console.log("token deployed to:", token.address);

  // verify token contract
  await hre.run("verify:verify", {
    address: "0x23FA7055e7BAf804b9024Afaaa9710dd38986AFd",
  ...
  //   constructorArguments: [token.address, admin, encodedFunctionSignature],
  // });
